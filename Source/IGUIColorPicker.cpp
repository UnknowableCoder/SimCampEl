...
namespace irr
{
    ...
    namespace gui
    {
              ...
              colorpos(0), isGradient(false), isColor(false), isExtended(false), useAdvenced(uad)
        {
            ...
            close->setOverrideFont(Environment->getBuiltInFont());

            IGUISkin *skin = Environment->getSkin();

            extend = Environment->addButton({110, 5, 120, 156}, this);
            extend->setOverrideFont(Environment->getBuiltInFont());
            ...
            #define implement_scrollbar(i, text, x, max) \
                ...
                tx[i][0]->setOverrideFont(Environment->getBuiltInFont()); \
                tx[i][1]->setOverrideFont(Environment->getBuiltInFont()); \
